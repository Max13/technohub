...
@section('content')
    ...
    <main class="container py-4">
        ...
        <div class="row my-4">
            <div class="col-md-8 offset-md-2">
                <div class="card">
                    <div class="card-header" data-bs-toggle="collapse" data-bs-target="#sym_encryption_collapse" aria-expanded="false" aria-controls="sym_encryption_collapse">{{ __('Symmetric encryption') }}</div>
                    <div class="card-body collapse" id="sym_encryption_collapse">
                        <form>
                            <div class="mb-3">
                                <label for="sym_encryption_algorithm" class="form-label">{{ __('Algorithm') }}</label>
                                <select class="form-select" id="sym_encryption_algorithm" aria-describedby="sym_encryption_algorithm_help" data-localstore>
                                    <option>AES-CBC</option>{{-- TODO --}}
                                </select>
                                <div id="sym_encryption_algorithm_help" class="form-text"></div>
                            </div>
                            <hr>
                            <div class="mb-3">
                                <label for="sym_encryption_text" class="form-label">{{ __('Text to hash') }}</label>
                                <textarea class="form-control" id="sym_encryption_text"></textarea>
                                <div class="row mt-3 align-items-center">
                                    <div class="col-auto">
                                        <button type="button" id="sym_encryption_text_btn" class="btn btn-primary">{{ __('Submit') }}</button>
                                    </div>
                                    <div class="col" id="sym_encryption_text_result"></div>
                                </div>
                            </div>
                            <hr>
                            <div class="mb-3">
                                <label for="sym_encryption_file" class="form-label">{{ __('File to hash') }}</label>
                                <input class="form-control" type="file" id="sym_encryption_file">
                                <div class="row mt-3 align-items-center">
                                    <div class="col-auto">
                                        <button type="button" id="sym_encryption_file_btn" class="btn btn-primary">{{ __('Submit') }}</button>
                                    </div>
                                    <div class="col" id="sym_encryption_file_result"></div>
                                </div>
                            </div>
                        </form>
                        <script>
